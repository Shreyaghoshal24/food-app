...
const Body = () => {
  ...
  const RestaurantPromoted = restaurantPromoted(RestaurantCard);
      ...
      <div className="res-container">
        {filteredResturant.map((resturant) => (
          <Link
            ...
            className="link"
          >
            {resturant.card.card.info.promoted === true? <RestaurantPromoted resData={resturant}/>:<RestaurantCard resData={resturant} />}    
          </Link>
        ))}
      </div>
    </div>
